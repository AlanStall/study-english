...
export function StudyList() {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="card bg-base-100 shadow-xl m-2 xs2:my-4 xs2:py-4 sm:mx-10 lg:mx-32">
          <div className="">
            ...
            <h4 className="text-[10px] xs:pt-3 xs:text-[14px] xs:font-bold lg:text-[16px]">Veja cada palavra de forma aleatória:</h4>
            <br></br>
            ...
            <br></br>            
            <div className="">
              <button className="btn btn-xs btn-outline btn-primary lg:btn-md" onClick={captureRandomWord}>
                Outra palavra
              </button>
              <button
              ...
              <button className="btn btn-xs btn-outline btn-primary lg:btn-md" onClick={editWordsRandom}>
                Editar
              </button>
              <button
                className="btn btn-xs btn-outline btn-primary lg:btn-md"
              ...
              <button className="btn btn-xs btn-outline btn-primary lg:btn-md" onClick={() => navigate('/add')}>
                ADICIONAR
              </button>
            </div>
            <br></br>
            ...
            <div className="form-control">
              <div className="input-group">
                ...
                ></input>
                <button className="btn btn-xs mr-auto m-0 xs:btn-sm" onClick={findNumberAndClearInput}>
                  <svg
            ...
            <div className="buttons-my-list">
              <button className="btn btn-xs h-8 btn-outline btn-primary xs2:h-6 lg:btn-md" onClick={first}>
                Primeira palavra
              </button>
              <button
              ...
              <button
                className="btn btn-xs btn-outline btn-primary lg:btn-md"
                id="translation-word-not-random"
      ...
      <section className="">
        <h1 className="font-bold text-[14px] text-[#570DF8] py-6 ">
          LISTA COMPLETA
        </h1>
        <div className="overflow-x-auto bg-gray-300 rounded-t-xl py-3 pb-6 p-1 sm:pt-3 sm:p-8">
          <table className="table-fixed w-full shadow-xl">
            <thead className='p-3'>
              <tr>
                <th className="pb-3 text-[#570DF8] font-bold text-[10px] xs:text-[12px]">EM INGLÊS</th>
                <th className="pb-3 text-[#570DF8] font-bold text-[10px] xs:text-[12px]">EM PORTUGUÊS</th>
            ...
            <tbody className="">
              {wordByWord?.map((word) => (
                <tr className="bg-white hover:bg-gray-100" key={word.id}>
                  <td className="border-solid border-2 break-words p-0.5 text-[10px] xs2:font-bold xs:text-[12px] ssm:text-[14px]">{word.inEnglish}</td>
                  ...
                  <td className="buttons-line border-solid border-2">                   
                      <button className="btn-outline relative top-[4px] m-0 p-0" style={{ borderRadius: '5px' }} onClick={() => showEachWord(word)}>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="25px"
                          height="30px"
                    ...
                    <button className="btn-outline relative top-[4px] m-0 p-0" style={{ borderRadius: '5px' }} onClick={() => navigate(`/Edit/${word.id}`)}>
                      ...
                      <button className="btn-outline relative top-[4px] m-0 p-0" style={{ borderRadius: '5px' }} onClick={() => deleteEachWord(word)}>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="25px" 
                          height="25px" 
