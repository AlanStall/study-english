      ...
      <div className="grid grid-flow-col bg-blue-900 p-1 mx-1 my-3 sm:mx-3 rounded-lg">
        <div className="flex justify-start gap-1">
          <div className="card w-[65px] h-[50px]">
            <a className="btn btn-ghost fill-[#ffffff]" onClick={() => navigate('/')}>
              <svg>
          ...
          <div className="">
            <div className="dropdown dropdown-right">
              ...
              <ul
                tabIndex={0}
                className="menu menu-compact dropdown-content bg-blue-600 rounded-box"
              >
                <li>
                  <button
                    className="btn btn-ghost btn-xs normal-case content-center py-6 text-[7px] w-[120px] xs:text-[10px] xs:w-[150px] sm:py-4 sm:text-[10px] sm:w-[300px]"
        ...
        <div className="flex justify-end">
          <button
            className="btn btn-ghost normal-case text-[18px] sm:text-[20px]"
            onClick={() => navigate('/')}
          >
            Study English
          </button>
