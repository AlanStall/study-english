    ...
    >
      ...
      <div className="grid grid-flow-col gap-2">
        <a
          ...
          className="btn-outline rounded-md w-12 h-[45px] p-0.5 flex justify-center fill-blue-600 hover:fill-[#171515]"
          target="_blank"
          title="GitHub"
          aria-label="GitHub"
        >
        ...
        <a
          ...
          className="btn-outline rounded-md w-12 h-[45px] p-0.5 flex justify-center fill-blue-600 hover:fill-[#0A66C2]"
          target="_blank"
          title="LinkedIn"
          aria-label="LinkedIn"
        >
      ...
      <div className="info">
        <div className="grid grid-flow-col gap-1">
          ...
          <CopyToClipboard text="alan_kstall@hotmail.com">
            <button className="btn btn-outline btn-xs text-[9px] sm:text-[10px] pt-1 content-center">
              Copiar e-mail
            </button>
          </CopyToClipboard>
        </div>
