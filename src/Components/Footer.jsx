  ...
  return (
    ...
    >
      <div className="grid grid-flow-col gap-4">
        <a className="link link-hover developer" href="https://github.com/AlanStall">
          Desenvolvedor
        </a>
        <a
          className="link link-hover contact"
      ...
      <div className="grid grid-flow-col gap-2">
        <a href="https://github.com/AlanStall">
          <button className="btn-outline icon-github" style={{ borderRadius: '5px' }}>
            <svg
        ...
        <a href="https://www.linkedin.com/in/alan-stall-b722a962/">
          <button className="btn-outline icon-linkedin" style={{ borderRadius: '5px' }}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="35"
              height="45"
